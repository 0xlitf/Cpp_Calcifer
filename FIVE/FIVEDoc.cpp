...
// 缩略图的支持
void CFIVEDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CFIVEDoc::InitializeSearchContent()
{
...
void CFIVEDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
