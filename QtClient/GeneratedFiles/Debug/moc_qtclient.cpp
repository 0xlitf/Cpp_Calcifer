...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtClient_t, stringdata) + ofs \
...
const QMetaObject QtClient::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QtClient.data,
...
void *QtClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtClient.stringdata))
