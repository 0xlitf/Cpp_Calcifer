...
#include <regex>
using namespace std;
string in_path = "E:/仙游/sots/文件名.txt";
...
/*
string in_path = "E:/响水涧/sots/jiankong.txt";
string out_path = "E:/响水涧/sots/jiankong.pic";
string compare1_path = "C:/Users/Azro/Desktop/响水涧连片.txt";
...
void Deal::do_it(){
	...
	while (fin.getline(dataline, 1024, '\n'))
	{
		...
		fout << "0" << "\n";
		fout << "  " << list-1 << "20.0000	  " << row << "30.0000" << "\n";
		fout << "  240.0000	  240.0000" << "\n";
		fout << "2" << "\n";
		fout << "1" << ' ' << "AN_File"<<index;
		fout << "\n\n\n";
